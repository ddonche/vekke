      ...
      sections: [
        {
          ...
          cost: "Cost: 3 Captured Enemy Tokens → Void",
          description: "If you don't want to wait until the end of your turn to do a free route swap, you can yield 3 captured enemy tokens to get an immediate route swap, which you can use during your turn.",
        ...
        },
        {
          ...
          cost: "Cost: 3 Reserve Tokens → Void",
          description: "If you want to have an extra reinforcement during that phase, you can yield 3 reserve tokens to the void. This lets you place 2 reinforcements at the end of your turn instead of 1. You cannot capture with reinforcements.",
      ...
      sections: [
        {
          ...
          cost: "Cost: 2 Captives + 2 Reserves → Void (Once Per Game)",
          description: "The only move you can do during your opponent's turn. You must yield 2 captured tokens and 2 reserve tokens to the void to use it. Move 1 token 1 space in any direction. You cannot move a sieged token. You cannot invade or capture with this move. You CAN undo a capture on that token with this.",
